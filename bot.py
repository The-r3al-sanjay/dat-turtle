...
async def invite(ctx):
    """Allow my bot to join dat lit place"""
    await ctx.send("here u go my dude: https://discordapp.com/api/oauth2/authorize?client_id=427990429418389505&permissions=0&scope=bot")
